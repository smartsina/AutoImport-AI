...
def ocr_mlx_vlm(image_path):
    ...
    prompt = """شما یک سیستم OCR تخصصی برای نامههای اداری رسمی ایران هستید.
وظیفه: تمام متن موجود در این تصویر را دقیقاً و کامل استخراج کنید.

دستورالعملهای مهم:
1. هدر نامه (بالای نامه) شامل: شماره نامه، تاریخ، پیوست را دقیقاً بخوانید
2. شماره نامه معمولاً به فرمت 1405/12345/44/56/ص یا مشابه است - دقیقاً همانطور بنویسید
3. تاریخ به فرمت سال/ماه/روز (مثلاً 1405/06/23) - دقیقاً بنویسید
4. ارقام فارسی را به انگلیسی تبدیل کنید
5. ترتیب خواندن: از راست به چپ برای متن فارسی، از چپ به راست برای اعداد و کدها
6. متن را خط به خط و به ترتیب منطقی سند استخراج کنید
7. هیچ توضیح، تفسیر یا متن اضافهای اضافه نکنید - فقط متن موجود در تصویر"""
