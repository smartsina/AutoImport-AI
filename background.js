...
متن زیر از یک نامه اداری استخراج شده است (احتمالاً با غلط‌های املایی یا کاراکترهای تکراری ناشی از OCR).
...
فرمت خروجی (فقط JSON):
{
  ...
  "description": "متن کامل نامه را غلط‌گیری کرده و به زبان فارسی روان، رسمی و خوانا بازنویسی کنید. اگر در متن اصلی جملات یا کاراکترهای تکراری و لوپ‌شده (مثل /۱/۱/۱/۱ یا -۴/۵-۴/۵ یا تکرار متوالی عبارات) وجود داشت، حتماً آن‌ها را پاک‌سازی و اصلاح کن تا متن نهایی کاملاً تمیز باشد",
